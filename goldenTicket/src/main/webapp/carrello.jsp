					...
					<div class="navbar">
						...
						<div class="login">
							<div class="search-container">
								...
								<a href="acquisti" id="" type="submit">ACQUISTI</a> <a
									href="logout" id="logout" type="submit">ESCI</a>
							</div>
						</div>
						<%
						} else {
			...
			<form action="checkout" method="get">
				...
				<div class="result">
					...
					<div class="infospettacolo">
						<p>
							Evento:
							<%=b.getEvento().getNome()%></p>
						<span>Data: <%=b.getEvento().getData()%></span>
						<p>
							Orario:
							<%=b.getEvento().getOra()%></p>
						<span>Fila: <%=b.getFila()%></span> <span>Posto: <%=b.getPosto()%></span>
